...
% 
% T_s = 298 + (GAST - 288)*0.89  ;  
% T_h = max( 275.5 + (GAST - 288)*1.43 , 271 ) ;
% T_d = max( 275.5 + (GAST - 288)*1.43 , 271 ) ;
% T_cont = GAST;
% T_p = T_s ;
% T_di = T_s ;
...
T_d = max( Td_pre_K + Delta_GAST * 1.43 , 271.5 );
T_cont = GAST_pre_K + Delta_GAST * 1.25;
