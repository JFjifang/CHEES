...
d13C_CH4 = interp1(pars.time,pars.d13C_methane,t) ;


%%%% sensitivity analysis
f_CH4 = CO2_input - (CO2_input * d13c_CO2_input + (d13C_CH4 * -1) * CO2_input)./((d13C_CH4 *-1) + pars.d13C_CO2);
f_volcanic_CO2 = (CO2_input * d13c_CO2_input + (d13C_CH4 * -1) * CO2_input)./((d13C_CH4 * -1) + pars.d13C_CO2);
...
fanoxic_p = 1/(1+exp(-12*(0.5*pripr_p/560e12 - O2_a/pars.O2_a_0)));%补充了缺氧对CP ratio的影响
CPratio_op = 250 ;
CPratio_ap = 1100 ;
...
workingstate.d13C_CH4(stepnumber,1) = d13C_CH4;
...
% workingstate.methanoOxid_a(stepnumber,1) =methanoOxid_a;
